    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('member.ticket-agent.index') }}">{{ $pageTitle }}</a></li>
...
@section('content')
    ...
    {!! Form::open(['id'=>'updateTicket2','class'=>'ajax-form','method'=>'PUT']) !!}
    <div class="form-body">
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
...
<script>
    ...
    $('.submit-ticket-2').click(function () {
        ...
        $.easyAjax({
            url: '{{route('member.ticket-agent.updateAgentOtherData', $ticket->id)}}',
