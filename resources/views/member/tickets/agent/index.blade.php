...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('member.ticket-agent.refreshCount', [':startDate', ':endDate', ':status', ':priority', ':channelId', ':typeId']) !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('member.ticket-agent.data', [':startDate', ':endDate', ':status', ':priority', ':channelId', ':typeId']) !!}';
