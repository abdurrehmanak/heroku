        ...
        <div class="col-md-12">
            ...
            <div class="white-box printableArea ribbon-wrapper">
                @if ($user->can('view_payments'))
                    <button type="button" onclick="showPayments()" class="btn btn-info pull-right">@lang('app.view') @lang('app.menu.payments')</button>
                    <button type="button" data-clipboard-text="{{ route('front.invoice', [md5($invoice->id)]) }}" class="btn btn-success pull-right m-r-10 btn-copy"><i class="fa fa-copy"></i> <span id="copy_payment_text">@lang('modules.invoices.copyPaymentLink')</span></button>
                @endif
