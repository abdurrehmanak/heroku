...
@section('page-title')
    <div class="row bg-title">
        ...
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12b text-right">
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('member.all-tasks.data') !!}?clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&status='+ status+'&_token={{ csrf_token() }}';
        ...
        table = $('#tasks-table').dataTable({
            ...
            columns: [
                ...
                {data: 'board_column', name: 'taskboard_columns.board_column'},
