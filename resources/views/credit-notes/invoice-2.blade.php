...
<div id="container">
    ...
    <div class="creditNote-body">
        ...
        <section id="sums">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="amount-total">
                    ...
                    <td>
                        <hr>{!! htmlentities($creditNote->currency->currency_symbol)  !!}{{ number_format((float)$creditNote->total, 2, '.', '') }}</td>
                </tr>
                <tr>
                    <th>
                        <hr>@lang("modules.credit-notes.creditAmountUsed"):</th>
                    <td>
                        <hr>{!! htmlentities($creditNote->currency->currency_symbol)  !!}{{ number_format((float)$creditNote->creditAmountUsed(), 2, '.', '') }}</td>
                </tr>
                <tr>
                    <th>
        ...
        <section id="terms">
            ...
            <div class="currency">
                <span>Here {!! htmlentities($creditNote->currency->currency_symbol)  !!} refers to {!! $creditNote->currency->currency_code  !!}</span>
