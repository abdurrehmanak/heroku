<div class="row">
    ...
    <p>
        ...
        ├──
        │
        │   └── <strong>Version 3.5.4</strong>
        │       └── Automatic task reminders (Check Task settings)
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.5.1/3.5.2/3.5.3</strong>
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.5.0</strong>
        │       └── Laravel upgraded to version 6.9.0
        │       └── New UI
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.4.2/3.4.3</strong>
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.4.1</strong>
        │       └── Added ability to unpaid invoices as Canceled
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.4.0</strong>
        │       └── New Feature: Manage contracts
        │       └── Allow multiple taxes in invoices
        │       └── Send notice to clients
        │       └── Now project is not required while creating invoices
        │       └── Gantt chart improvements
        │       └── Added option for task dependency
        ...
        │       └── Project Settings for project reminder (Requires cron setup)
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.1.0</strong>
        │       └── Added Razorpay Payment Gateway
        │       └── Added project status
        │       └── New Attendance summary page
        │       └── Show unpaid payments in project list (Project Budget - Payment Received)
        │       └── Employee Designations
        │       └── New pending leaves page
        │       └── New rounded theme (Set in theme settings)
        ...
        │       └── Laravel 5.8 Upgrade
        │       └── Code Optimization
        │       └── Add google recaptcha on login
        │       └── Generate public payment link for client to pay invoice (invoice dropdown in admin panel)
        │       └── Add external file link in project's files section
        │       └── Bug fixes
        │
        │   └── <strong>Version 2.5.6/2.5.7</strong>
        │       └── Bug fixes
        │
        │   └── <strong>Version 2.5.4/2.5.5</strong>
        │       └── Added manual update option in update log
        │       └── View notice detail button in notice board module
        │       └── Project tasks view changed
        │       └── Link project with expenses
        │       └── Added Leaves table
        │       └── Speed Optimization
        │       └── Bug fixes
        │
        ...
        │       └── Added products in the estimates
        │       └── Added category filters in project and task list
        │       └── Bug fixes
        │
        ...
        │       └── Added filters in task module
        │       └── Added budget and milestones feature in project section
        │       └── Bug fixes
        │
        │   └── <strong>Version 2.4.8</strong>
        │       └── Employee can create tasks for himself as default.
        │       └── Add weather api key in company settings.
        ...
        │       └── Added translations for roles and permission modules.
        |        (check modules > module.XXXX in translation manager.)
        │       └── Bug fixes
        │
