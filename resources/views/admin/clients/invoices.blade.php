            ...
            <div class="white-box">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6"> <strong>@lang('modules.client.companyName')</strong> <br>
                        <p class="text-muted">{{ (!is_null($client->client_details)) ? ucwords($client->client_details->company_name) : 'NA'}}</p>
                    </div>
                </div>
                <hr>
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6"> <strong>@lang('app.address')</strong> <br>
                        <p class="text-muted">{!!  (!is_null($client->client_details)) ? ucwords($client->client_details->address) : 'NA' !!}</p>
                    </div>
                </div>
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="{{ route('admin.clients.projects', $client->id) }}"><i class="icon-layers"></i> <span>@lang('app.menu.projects')</span></a>
                                <li class="tab-current"><a href="{{ route('admin.clients.invoices', $client->id) }}"><i class="icon-doc"></i> <span>@lang('app.menu.invoices')</span></a>
                                </li>
