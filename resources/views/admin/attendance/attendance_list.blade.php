        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <div class="col-md-1 col-xs-2">
                    {!!  ($row->image) ? '<img src="'.asset_url('avatar/'.$row->image).'" alt="user" class="img-circle" width="40">' : '<img src="'.asset('img/default-profile-2.png').'" alt="user" class="img-circle" width="40">' !!}
                </div>
