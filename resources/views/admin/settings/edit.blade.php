                ...
                <div class="col-md-12">
                    <div class="alert alert-success">
                        ...
                        <h5 class="text-white">Create a file with the name <code>.htaccess</code> at the root of folder
                            (where app, bootstrap, config folder lies) and add the following content</h5>
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    @if($cachedFile)
                        ...
                        <h6 class=" pull-right m-r-5">@lang('messages.cacheEnabled')</h6>
                    @else
                        ...
                        <h6 class=" pull-right m-r-5">@lang('messages.cacheDisabled')</h6>
                    @endif
