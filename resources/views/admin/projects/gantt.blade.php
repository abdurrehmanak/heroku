    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">@lang('modules.projects.viewGanttChart')</li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
...
@push('footer-script')
    ...
    <script src="{{ asset('js/gantt-export.js') }}"></script>  
    <script type="text/javascript">
        ...
        function showTable() {
            ...
            @if($ganttProjectId != '')
                var url = '{{ route("admin.projects.ganttData", $ganttProjectId) }}';
            @endif
