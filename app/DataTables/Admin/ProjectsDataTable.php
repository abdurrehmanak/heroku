...
class ProjectsDataTable extends BaseDataTable
{
    ...
    public function query(Project $model)
    {
        ...
        $model = $model->with('members', 'members.user', 'client', 'currency')->select('id', 'project_name', 'start_date', 'deadline', 'client_id', 'completion_percent', 'status', 'project_budget', 'currency_id');
