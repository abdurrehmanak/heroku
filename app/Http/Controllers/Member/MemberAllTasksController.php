...
class MemberAllTasksController extends MemberBaseController
{
    ...
    public function data(Request $request, $startDate = null, $endDate = null, $hideCompleted = null, $projectId = null)
    {
        ...
        $tasks = Task::leftJoin('projects', 'projects.id', '=', 'tasks.project_id')
            ...
            ->select('tasks.id', 'projects.project_name', 'tasks.heading', 'users.name', 'creator_user.name as created_by', 'creator_user.image as created_image', 'tasks.user_id as taskUserID', 'users.image', 'tasks.due_date', 'taskboard_columns.column_name as board_column', 'taskboard_columns.label_color', 'tasks.project_id')
        ...
        return DataTables::of($tasks)
            ...
            ->rawColumns(['board_column', 'action', 'project_name', 'clientName', 'created_by', 'due_date', 'name', 'heading'])
